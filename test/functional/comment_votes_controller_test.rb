...
class CommentVotesControllerTest < ActionController::TestCase
  ...
  test "should create comment_vote" do
    assert_difference('CommentVote.count') do
      post :create, comment_vote: { post_id: @comment_vote.post_id, user_id: @comment_vote.user_id, vote: @comment_vote.vote }
    end
  ...
  test "should update comment_vote" do
    put :update, id: @comment_vote, comment_vote: { post_id: @comment_vote.post_id, user_id: @comment_vote.user_id, vote: @comment_vote.vote }
    assert_redirected_to comment_vote_path(assigns(:comment_vote))
  end
