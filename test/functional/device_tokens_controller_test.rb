...
class DeviceTokensControllerTest < ActionController::TestCase
  ...
  test "should create device_token" do
    assert_difference('DeviceToken.count') do
      post :create, device_token: { android_device_token: @device_token.android_device_token, ios_device_token: @device_token.ios_device_token, user_id: @device_token.user_id }
    end
  ...
  test "should update device_token" do
    put :update, id: @device_token, device_token: { android_device_token: @device_token.android_device_token, ios_device_token: @device_token.ios_device_token, user_id: @device_token.user_id }
    assert_redirected_to device_token_path(assigns(:device_token))
  end
